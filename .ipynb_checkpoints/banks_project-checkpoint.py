...
def downloadExchangeRate():
    ...
    if response.status_code == 200:
        ...
        log_progress("Failed to download 'exchange_rate.csv'")
...
def printLog(message):
    ...
    banner_width = min(terminal_width, 250)
    banner_content = f" {message} "
    banner_line = "#" * banner_width
    banner = (f"""
{banner_line}
#{banner_content.center(banner_width - 2)}#
{banner_line}
    """)
